          ...
          <div className="relative container mx-auto px-4 py-16 z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl md:text-2xl mb-8 text-blue-100">
                The world's first decentralized prediction market built on
                BlockDAG's revolutionary technology. Trade on outcomes, earn
                rewards, and shape the future of prediction markets.
              </p>
      ...
      <footer className="border-t bg-card/50 mt-16">
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="border-t mt-8 pt-6 text-center text-sm text-muted-foreground">
            <p>&copy; 2025 BlockDAG Predictions. Built on BlockDAG Network.</p>
          </div>
        </div>
      </footer>
    </div>
